...
public class NqueensAlgorithm {
	private static int N=10;        //使用常量来定义，方便之后解N皇后问题
    ...
    public static void main(String[] args) {
        ...
        //select url from website where name = '百度';
        //insert into website (name.url,country) values ('百度','www.baidu.com','CN'); 
        //update website set url = 'google.us.com',country = 'USA' where name = '百度';
